...
public class LandDodge_Girl : CharacterState<GirlStateType>
{
    ...
    public LandDodge_Girl(Animator animator, 
                        ...
                        string dodgeBackAnimName):base(needsExitTime: true, canExit: (state) => ((LandDodge_Girl)state).AniFinsh)
    {
    ...
    public override void OnEnter()
    {
        ...
        inputManager.SetDodgeInputWindow(false);
    ...
    public override void OnExit()
    {
        ...
        inputManager?.SetDodgeInputWindow(true);
